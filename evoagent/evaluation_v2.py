...
class ProductArmReviewer:
    ...
    def __init__(
        ...
        # All 19 quant review rules live in LocalRuleReviewer.  ContextRuleReviewer
        # is empty by design to avoid duplicate findings across arms, so the
        # deterministic rule count equals len(LocalRuleReviewer.RULES).
    ...
    def evaluation_config(self) -> dict:
        return {
            ...
            "deterministic_rules": len(LocalRuleReviewer.RULES) + len(ContextRuleReviewer.RULES),

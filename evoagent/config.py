...
class Settings:
    ...
    backtest_data_dir: str = "data/market"
    backtest_sandbox_timeout_seconds: int = 60
    backtest_initial_capital_default: float = 10000.0
    ...
    def from_env(cls) -> "Settings":
        return cls(
            ...
            open_registration=_bool("EVOAGENT_OPEN_REGISTRATION", True),
            ...
            backtest_data_dir=os.getenv("EVOAGENT_BACKTEST_DATA_DIR", "data/market"),
            backtest_sandbox_timeout_seconds=_int(
                "EVOAGENT_BACKTEST_SANDBOX_TIMEOUT_SECONDS", 60
            ),
            backtest_initial_capital_default=float(
                os.getenv("EVOAGENT_BACKTEST_INITIAL_CAPITAL_DEFAULT", "10000.0")
            ),
            backtest_commission=float(os.getenv("EVOAGENT_BACKTEST_COMMISSION", "0.0003")),
        )

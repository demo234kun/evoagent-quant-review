...
RULE_TO_CWE = {
    ...
    # Quantitative-trading review taxonomy. The rule id itself is the
    # canonical identity the evaluator matches against (no CWE analogue).
    "QUANT-FF-SHIFT-NEG": "QUANT-FF-SHIFT-NEG",
    "QUANT-FF-REF-NEG": "QUANT-FF-REF-NEG",
    "QUANT-FF-DATETIME-NOW": "QUANT-FF-DATETIME-NOW",
    "QUANT-FF-GETPRICE-NOW": "QUANT-FF-GETPRICE-NOW",
    "QUANT-FF-CHEAT-CLOSE": "QUANT-FF-CHEAT-CLOSE",
    "QUANT-LK-FULL-NORM": "QUANT-LK-FULL-NORM",
    "QUANT-LK-FULL-ZSCORE": "QUANT-LK-FULL-ZSCORE",
    "QUANT-LK-FORWARD-FILL": "QUANT-LK-FORWARD-FILL",
    "QUANT-LK-STATDATE": "QUANT-LK-STATDATE",
    "QUANT-LK-INDEX-NOW": "QUANT-LK-INDEX-NOW",
    "QUANT-SEC-HARDCODED-KEY": "QUANT-SEC-HARDCODED-KEY",
    "QUANT-SEC-NO-RISK": "QUANT-SEC-NO-RISK",
    "QUANT-EX-ZERO-SLIP": "QUANT-EX-ZERO-SLIP",
    "QUANT-EX-ZERO-COMM": "QUANT-EX-ZERO-COMM",
    "QUANT-OF-OPTSTRATEGY": "QUANT-OF-OPTSTRATEGY",
    "QUANT-OF-GRIDSEARCH": "QUANT-OF-GRIDSEARCH",
    "QUANT-DQ-ADJUST-POST": "QUANT-DQ-ADJUST-POST",
    "QUANT-DQ-FILLNA0": "QUANT-DQ-FILLNA0",
    "QUANT-REL-DEBUG-PRINT": "QUANT-REL-DEBUG-PRINT",
}

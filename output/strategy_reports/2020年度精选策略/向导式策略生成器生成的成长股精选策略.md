...
**Repository:** `聚宽2020/向导式策略生成器生成的成长股精选策略`  
**Risk:** `medium`  
...
`向导式策略生成器生成的成长股精选策略.py:27` · **MEDIUM** · `QUANT-EX-ZERO-ORDERCOST`
...
**证据引用：** `local-rule:f1dffd961d61c6f4`
...
`向导式策略生成器生成的成长股精选策略.py:363` · **MEDIUM** · `QUANT-REL-NO-EXCEPTION`
...
**证据引用：** `local-rule:d958a42e1fad797a`
...
`向导式策略生成器生成的成长股精选策略.py:423` · **MEDIUM** · `QUANT-LK-INDEX-NOW`
...
**证据引用：** `local-rule:dce0e76ba81e807b`

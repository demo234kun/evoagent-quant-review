...
**Repository:** `聚宽2020/兄台且慢，去天台排队不如看看这个策略先`  
**Risk:** `high`  
...
`兄台且慢，去天台排队不如看看这个策略先.py:68` · **HIGH** · `QUANT-FF-GETPRICE-NO-ENDDATE`
...
**证据引用：** `local-rule:59a074d3a6852e7a`, `diff-ast:5dbaf720619ddeaa`

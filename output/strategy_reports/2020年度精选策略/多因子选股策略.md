...
`多因子选股策略.py:80` · **HIGH** · `QUANT-FF-GETPRICE-NO-ENDDATE`
...
**证据引用：** `local-rule:c50fd295d7ffdf57`, `diff-ast:64e78db5ad85b540`
...
`多因子选股策略.py:67` · **MEDIUM** · `QUANT-LK-INDEX-NOW`
...
**证据引用：** `local-rule:218b2fca84494947`

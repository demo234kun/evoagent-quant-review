...
- Token 成本: `$0.00000000`；延迟: `226 ms`

## 审查发现

### 1. 🟠 set_order_cost 佣金/税费设为 0，回测收益虚高

`向导式.py:27` · **MEDIUM** · `QUANT-EX-ZERO-ORDERCOST`
...
**证据引用：** `local-rule:8b08d1b412e55fc1`
...
`向导式.py:361` · **MEDIUM** · `QUANT-REL-NO-EXCEPTION`
...
**证据引用：** `local-rule:fa4b2fb86e7b1fe2`
...
`向导式.py:421` · **MEDIUM** · `QUANT-LK-INDEX-NOW`
...
**证据引用：** `local-rule:52f37cd407d19a9f`

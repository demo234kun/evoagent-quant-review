...
**Repository:** `聚宽2020/沪深300ETF-1060双均线`  
**Risk:** `medium`  
...
`沪深300ETF-1060双均线.py:18` · **MEDIUM** · `QUANT-EX-ZERO-ORDERCOST`
...
**证据引用：** `local-rule:f4680cc3cb6eaaa4`
...
`沪深300ETF-1060双均线.py:20` · **MEDIUM** · `QUANT-EX-ZERO-COMM`
...
**证据引用：** `local-rule:e2f04703a698e14c`

...
`追三板策略.py:22` · **MEDIUM** · `QUANT-EX-ZERO-ORDERCOST`
...
**证据引用：** `local-rule:341a6b9b766a5db6`
...
`追三板策略.py:24` · **MEDIUM** · `QUANT-EX-ZERO-COMM`
...
**证据引用：** `local-rule:a5459c3792f75a6b`

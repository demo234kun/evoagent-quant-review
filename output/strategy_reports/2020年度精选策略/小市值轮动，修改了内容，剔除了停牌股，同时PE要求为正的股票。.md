...
**Repository:** `聚宽2020/小市值轮动，修改了内容，剔除了停牌股，同时PE要求为正的股票。`  
**Risk:** `high`  
...
`小市值轮动，修改了内容，剔除了停牌股，同时PE要求为正的股票。.py:28` · **HIGH** · `QUANT-FF-GETPRICE-NO-ENDDATE`
...
**证据引用：** `local-rule:e59307117160e777`, `diff-ast:d5d24d9f178b9ab8`
...
`小市值轮动，修改了内容，剔除了停牌股，同时PE要求为正的股票。.py:26` · **MEDIUM** · `QUANT-LK-INDEX-NOW`
...
**证据引用：** `local-rule:beac2820e6e80907`

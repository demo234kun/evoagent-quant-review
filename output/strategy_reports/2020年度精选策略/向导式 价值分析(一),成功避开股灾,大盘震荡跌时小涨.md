...
**Repository:** `聚宽2020/向导式 价值分析(一),成功避开股灾,大盘震荡跌时小涨`  
**Risk:** `medium`  
...
`向导式 价值分析(一),成功避开股灾,大盘震荡跌时小涨.py:27` · **MEDIUM** · `QUANT-EX-ZERO-ORDERCOST`
...
**证据引用：** `local-rule:07241b29002f14f2`
...
`向导式 价值分析(一),成功避开股灾,大盘震荡跌时小涨.py:363` · **MEDIUM** · `QUANT-REL-NO-EXCEPTION`
...
**证据引用：** `local-rule:7a326b58e1aab9e8`
...
`向导式 价值分析(一),成功避开股灾,大盘震荡跌时小涨.py:423` · **MEDIUM** · `QUANT-LK-INDEX-NOW`
...
**证据引用：** `local-rule:7c92d07e6a441fb6`

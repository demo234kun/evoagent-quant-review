...
**Repository:** `聚宽2020/一位小白编辑的多因子选股策略`  
**Risk:** `medium`  
...
`一位小白编辑的多因子选股策略.py:27` · **MEDIUM** · `QUANT-EX-ZERO-ORDERCOST`
...
**证据引用：** `local-rule:543f1b5b3004e966`
...
`一位小白编辑的多因子选股策略.py:365` · **MEDIUM** · `QUANT-REL-NO-EXCEPTION`
...
**证据引用：** `local-rule:f89654955a4c677d`
...
`一位小白编辑的多因子选股策略.py:425` · **MEDIUM** · `QUANT-LK-INDEX-NOW`
...
**证据引用：** `local-rule:81a165c5da253277`

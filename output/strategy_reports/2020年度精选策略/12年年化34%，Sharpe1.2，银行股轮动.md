...
**Repository:** `聚宽2020/12年年化34%，Sharpe1.2，银行股轮动`  
**Risk:** `medium`  
...
- Token 成本: `$0.00000000`；延迟: `239 ms`

## 审查发现

### 1. 🟠 set_order_cost 佣金/税费设为 0，回测收益虚高

`12年年化34%，Sharpe1.2，银行股轮动.py:27` · **MEDIUM** · `QUANT-EX-ZERO-ORDERCOST`
...
**证据引用：** `local-rule:11ce34a7989bbed0`
...
`12年年化34%，Sharpe1.2，银行股轮动.py:369` · **MEDIUM** · `QUANT-REL-NO-EXCEPTION`
...
**证据引用：** `local-rule:ffa6c6cc062ce72c`
...
`12年年化34%，Sharpe1.2，银行股轮动.py:429` · **MEDIUM** · `QUANT-LK-INDEX-NOW`
...
**证据引用：** `local-rule:993453c05a0f7434`

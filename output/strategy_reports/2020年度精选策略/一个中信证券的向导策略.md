...
- Token 成本: `$0.00000000`；延迟: `218 ms`

## 审查发现

### 1. 🟠 set_order_cost 佣金/税费设为 0，回测收益虚高

`一个中信证券的向导策略.py:27` · **MEDIUM** · `QUANT-EX-ZERO-ORDERCOST`
...
**证据引用：** `local-rule:994aae3b6efd4d99`
...
`一个中信证券的向导策略.py:369` · **MEDIUM** · `QUANT-REL-NO-EXCEPTION`
...
**证据引用：** `local-rule:87abb83dc33d6793`
...
`一个中信证券的向导策略.py:429` · **MEDIUM** · `QUANT-LK-INDEX-NOW`
...
**证据引用：** `local-rule:72d610bc46881848`

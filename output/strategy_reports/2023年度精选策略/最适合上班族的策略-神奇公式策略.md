...
**Repository:** `聚宽2023/最适合上班族的策略-神奇公式策略`  
**Risk:** `medium`  
...
- Token 成本: `$0.00000000`；延迟: `305 ms`

## 审查发现

### 1. 🟠 set_order_cost 佣金/税费设为 0，回测收益虚高

`最适合上班族的策略-神奇公式策略.py:29` · **MEDIUM** · `QUANT-EX-ZERO-ORDERCOST`
...
**证据引用：** `local-rule:75a6c576d17c4ff6`
...
`最适合上班族的策略-神奇公式策略.py:380` · **MEDIUM** · `QUANT-REL-NO-EXCEPTION`
...
**证据引用：** `local-rule:eec23782027351e6`
...
`最适合上班族的策略-神奇公式策略.py:440` · **MEDIUM** · `QUANT-LK-INDEX-NOW`
...
**证据引用：** `local-rule:39969d116e769dcf`

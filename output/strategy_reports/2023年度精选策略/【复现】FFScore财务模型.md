...
**Repository:** `聚宽2023/【复现】FFScore财务模型`  
**Risk:** `high`  
...
`【复现】FFScore财务模型.py:120` · **HIGH** · `QUANT-FF-GETPRICE-NO-ENDDATE`
...
**证据引用：** `local-rule:6aa266bdb51157aa`, `diff-ast:6d756888ffc1e17d`
...
`【复现】FFScore财务模型.py:105` · **MEDIUM** · `QUANT-LK-INDEX-NOW`
...
**证据引用：** `local-rule:74d21eddd2f12920`

...
**Repository:** `聚宽2023/F_Score 选股，年化80%+`  
**Risk:** `medium`  
...
`F_Score 选股，年化80%+.py:47` · **MEDIUM** · `QUANT-LK-INDEX-NOW`
...
**证据引用：** `local-rule:8201d4dc74004fc7`
...
`F_Score 选股，年化80%+.py:73` · **MEDIUM** · `QUANT-LK-INDEX-NOW`
...
**证据引用：** `local-rule:36cd5927e7e05d37`

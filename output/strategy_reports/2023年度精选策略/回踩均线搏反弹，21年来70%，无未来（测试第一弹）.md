...
**Repository:** `聚宽2023/回踩均线搏反弹，21年来70%，无未来（测试第一弹）`  
**Risk:** `high`  
...
`回踩均线搏反弹，21年来70%，无未来（测试第一弹）.py:202` · **HIGH** · `QUANT-FF-GETPRICE-NO-ENDDATE`
...
**证据引用：** `local-rule:4a3867a0bbc28ea2`, `diff-ast:3b0311b7a4c49521`
...
`回踩均线搏反弹，21年来70%，无未来（测试第一弹）.py:280` · **MEDIUM** · `QUANT-EX-ZERO-ORDERCOST`
...
**证据引用：** `local-rule:0bfbd4688375ce88`
...
`回踩均线搏反弹，21年来70%，无未来（测试第一弹）.py:282` · **MEDIUM** · `QUANT-EX-ZERO-COMM`
...
**证据引用：** `local-rule:f4abb459b5d38e25`

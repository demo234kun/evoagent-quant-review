...
`选取向上趋势的股票.py:15` · **HIGH** · `QUANT-FF-GETPRICE-NO-ENDDATE`
...
**证据引用：** `local-rule:ceb831e3d5301166`, `diff-ast:266e8ebe43ad7ce4`
...
`选取向上趋势的股票.py:85` · **HIGH** · `QUANT-FF-GETPRICE-NO-ENDDATE`
...
**证据引用：** `local-rule:488e4fe1a148181f`, `diff-ast:90e6571470867f17`
...
`选取向上趋势的股票.py:34` · **LOW** · `QUANT-CQ-DEBUG-PLOT`
...
**证据引用：** `scanner:QUANT-CQ-DEBUG-PLOT:选取向上趋势的股票.py:34`
...
`选取向上趋势的股票.py:61` · **LOW** · `QUANT-CQ-DEBUG-PLOT`
...
**证据引用：** `scanner:QUANT-CQ-DEBUG-PLOT:选取向上趋势的股票.py:61`

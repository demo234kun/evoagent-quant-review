...
- Token 成本: `$0.00000000`；延迟: `248 ms`

## 审查发现

### 1. 🔴 get_price 未指定结束日期，默认拉取当前时刻数据

`大小外择时小市值.py:142` · **HIGH** · `QUANT-FF-GETPRICE-NO-ENDDATE`
...
**证据引用：** `local-rule:7227b19cdad4373e`, `diff-ast:1550e69ad69c3861`
...
`大小外择时小市值.py:151` · **HIGH** · `QUANT-FF-GETPRICE-NO-ENDDATE`
...
**证据引用：** `local-rule:7fd9ca930904fa81`, `diff-ast:5a166e3b8a08bc4d`
...
`大小外择时小市值.py:25` · **MEDIUM** · `QUANT-EX-ZERO-ORDERCOST`
...
**证据引用：** `local-rule:bbc9247245bc30c8`
...
`大小外择时小市值.py:26` · **MEDIUM** · `QUANT-EX-ZERO-COMM`
...
**证据引用：** `local-rule:c906df200ce3a1cc`
...
`大小外择时小市值.py:161` · **MEDIUM** · `QUANT-LK-INDEX-NOW`
...
**证据引用：** `local-rule:55b4057360d70249`
...
`大小外择时小市值.py:186` · **MEDIUM** · `QUANT-LK-INDEX-NOW`
...
**证据引用：** `local-rule:f61341beafc35a44`
...
`大小外择时小市值.py:294` · **MEDIUM** · `QUANT-LK-INDEX-NOW`
...
**证据引用：** `local-rule:1e240d0c53997f27`
...
`大小外择时小市值.py:299` · **MEDIUM** · `QUANT-LK-INDEX-NOW`
...
**证据引用：** `local-rule:f7165bd7ae968a87`
...
`大小外择时小市值.py:358` · **MEDIUM** · `QUANT-LK-INDEX-NOW`
...
**证据引用：** `local-rule:a8d28927b1a8b265`
...
`大小外择时小市值.py:371` · **MEDIUM** · `QUANT-LK-INDEX-NOW`
...
**证据引用：** `local-rule:4d1def8f3eebd580`

...
`高增股池小市值轮动.py:158` · **HIGH** · `QUANT-FF-GETPRICE-NO-ENDDATE`
...
**证据引用：** `local-rule:3447b5ffb17a24a4`, `diff-ast:fa2e27c9819485c4`
...
`高增股池小市值轮动.py:182` · **HIGH** · `QUANT-FF-GETPRICE-NO-ENDDATE`
...
**证据引用：** `local-rule:a29b6104d9861679`, `diff-ast:beffe213210e7070`
...
`高增股池小市值轮动.py:193` · **HIGH** · `QUANT-FF-GETPRICE-NO-ENDDATE`
...
**证据引用：** `local-rule:8107a54076f51a27`, `diff-ast:d1469c1af9f3498e`

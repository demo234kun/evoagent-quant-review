...
**Repository:** `聚宽2025/量化进阶学习笔记——打板策略`  
**Risk:** `high`  
...
`量化进阶学习笔记——打板策略.py:59` · **HIGH** · `QUANT-FF-GETPRICE-NO-ENDDATE`
...
**证据引用：** `local-rule:2a3afa0ff4fc65d3`, `diff-ast:8a1b542d78be4124`
...
`量化进阶学习笔记——打板策略.py:209` · **HIGH** · `QUANT-FF-GETPRICE-NO-ENDDATE`
...
**证据引用：** `local-rule:88c8fabaf6c516a8`, `diff-ast:0028b381f4433ec8`
...
`量化进阶学习笔记——打板策略.py:227` · **HIGH** · `QUANT-FF-GETPRICE-NO-ENDDATE`
...
**证据引用：** `local-rule:8905cd3e236f4276`, `diff-ast:d2947b3019cb3333`
...
`量化进阶学习笔记——打板策略.py:236` · **HIGH** · `QUANT-FF-GETPRICE-NO-ENDDATE`
...
**证据引用：** `local-rule:d67434efc0025b95`, `diff-ast:fb7e9d85bb26c137`
...
`量化进阶学习笔记——打板策略.py:273` · **HIGH** · `QUANT-FF-GETPRICE-NO-ENDDATE`
...
**证据引用：** `local-rule:a77de8c7b471fdc3`, `diff-ast:a0d22aa840117c0b`

...
**Repository:** `聚宽2025/“四大搅屎棍策略”学习笔记-有魔改`  
**Risk:** `high`  
...
`“四大搅屎棍策略”学习笔记-有魔改.py:133` · **HIGH** · `QUANT-FF-GETPRICE-NO-ENDDATE`
...
**证据引用：** `local-rule:121e9120dcbde54e`, `diff-ast:10e34e147f525688`
...
`“四大搅屎棍策略”学习笔记-有魔改.py:28` · **MEDIUM** · `QUANT-EX-ZERO-ORDERCOST`
...
**证据引用：** `local-rule:981aeccd43b491ca`
...
`“四大搅屎棍策略”学习笔记-有魔改.py:29` · **MEDIUM** · `QUANT-EX-ZERO-COMM`
...
**证据引用：** `local-rule:1ca4ba51acba05a2`
...
`“四大搅屎棍策略”学习笔记-有魔改.py:130` · **MEDIUM** · `QUANT-LK-INDEX-NOW`
...
**证据引用：** `local-rule:7e031d98b83731bd`
...
`“四大搅屎棍策略”学习笔记-有魔改.py:152` · **MEDIUM** · `QUANT-LK-INDEX-NOW`
...
**证据引用：** `local-rule:40decd70daa70add`

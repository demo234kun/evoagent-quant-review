...
**Repository:** `聚宽2025/小市值排除3个bug版，22年至今收益506`  
**Risk:** `high`  
...
`小市值排除3个bug版，22年至今收益506.py:78` · **HIGH** · `QUANT-FF-GETPRICE-NO-ENDDATE`
...
**证据引用：** `local-rule:5fe0bf98516e117d`, `diff-ast:e35b1e1841592118`
...
`小市值排除3个bug版，22年至今收益506.py:167` · **HIGH** · `QUANT-FF-GETPRICE-NO-ENDDATE`
...
**证据引用：** `local-rule:73d2070d9ab7005b`, `diff-ast:d0360ce8af2cc9c6`
...
`小市值排除3个bug版，22年至今收益506.py:249` · **HIGH** · `QUANT-FF-GETPRICE-NO-ENDDATE`
...
**证据引用：** `local-rule:81f68bfa51e0d53f`, `diff-ast:d5b151a7bcfeb127`
...
`小市值排除3个bug版，22年至今收益506.py:34` · **MEDIUM** · `QUANT-EX-ZERO-COMM`
...
**证据引用：** `local-rule:9e0b42ee4e309ce6`
...
`小市值排除3个bug版，22年至今收益506.py:90` · **MEDIUM** · `QUANT-LK-INDEX-NOW`
...
**证据引用：** `local-rule:d47cba6e8e5861e8`
...
`小市值排除3个bug版，22年至今收益506.py:231` · **MEDIUM** · `QUANT-LK-INDEX-NOW`
...
**证据引用：** `local-rule:1bfcbf16e4559bdb`

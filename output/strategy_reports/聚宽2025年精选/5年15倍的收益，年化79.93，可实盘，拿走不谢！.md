...
**Repository:** `聚宽2025/5年15倍的收益，年化79.93，可实盘，拿走不谢！`  
**Risk:** `high`  
...
**证据引用：** `local-rule:c4f160529a0fa40f`, `diff-ast:d131e49daf93274a`
...
**证据引用：** `local-rule:815fd1063cd06ca8`
...
**证据引用：** `local-rule:7e5721ac74236f48`

...
**Repository:** `聚宽2025/国九条 年化130.74% 回撤11% 众神Debug版`  
**Risk:** `high`  
...
`国九条 年化130.74% 回撤11% 众神Debug版.py:82` · **HIGH** · `QUANT-FF-GETPRICE-NO-ENDDATE`
...
**证据引用：** `local-rule:04fe37f0a690eb91`, `diff-ast:f0223ad1bf61d2d9`
...
`国九条 年化130.74% 回撤11% 众神Debug版.py:162` · **HIGH** · `QUANT-FF-GETPRICE-NO-ENDDATE`
...
**证据引用：** `local-rule:34e482c066c727cf`, `diff-ast:3eccadd553cbd7c3`
...
`国九条 年化130.74% 回撤11% 众神Debug版.py:34` · **MEDIUM** · `QUANT-EX-ZERO-COMM`
...
**证据引用：** `local-rule:f6b6fc32cc84d59a`
...
`国九条 年化130.74% 回撤11% 众神Debug版.py:94` · **MEDIUM** · `QUANT-LK-INDEX-NOW`
...
**证据引用：** `local-rule:ff3670add53962ab`
...
`国九条 年化130.74% 回撤11% 众神Debug版.py:220` · **MEDIUM** · `QUANT-LK-INDEX-NOW`
...
**证据引用：** `local-rule:b12978cc303d0989`

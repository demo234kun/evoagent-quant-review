...
- Token 成本: `$0.00000000`；延迟: `233 ms`

## 审查发现

### 1. 🔴 get_price 未指定结束日期，默认拉取当前时刻数据

`大小外择时小市值3.0.py:145` · **HIGH** · `QUANT-FF-GETPRICE-NO-ENDDATE`
...
**证据引用：** `local-rule:c2352de2c38b194b`, `diff-ast:314f9837f085b2f7`
...
`大小外择时小市值3.0.py:154` · **HIGH** · `QUANT-FF-GETPRICE-NO-ENDDATE`
...
**证据引用：** `local-rule:9521f791df13e2d0`, `diff-ast:ce8ac19af784cd61`
...
`大小外择时小市值3.0.py:29` · **MEDIUM** · `QUANT-EX-ZERO-ORDERCOST`
...
**证据引用：** `local-rule:30846e776d922a06`
...
`大小外择时小市值3.0.py:30` · **MEDIUM** · `QUANT-EX-ZERO-COMM`
...
**证据引用：** `local-rule:2f59fcb5251a7836`
...
`大小外择时小市值3.0.py:164` · **MEDIUM** · `QUANT-LK-INDEX-NOW`
...
**证据引用：** `local-rule:3d82ed5d19f7d961`
...
`大小外择时小市值3.0.py:189` · **MEDIUM** · `QUANT-LK-INDEX-NOW`
...
**证据引用：** `local-rule:751513ce8be20984`
...
`大小外择时小市值3.0.py:243` · **MEDIUM** · `QUANT-LK-INDEX-NOW`
...
**证据引用：** `local-rule:5cb4a82986e56856`
...
`大小外择时小市值3.0.py:248` · **MEDIUM** · `QUANT-LK-INDEX-NOW`
...
**证据引用：** `local-rule:9c8e834f379bdfb3`
...
`大小外择时小市值3.0.py:319` · **MEDIUM** · `QUANT-LK-INDEX-NOW`
...
**证据引用：** `local-rule:13531541478a6788`
...
`大小外择时小市值3.0.py:440` · **MEDIUM** · `QUANT-LK-INDEX-NOW`
...
**证据引用：** `local-rule:1a5bfe6dd7ab989f`

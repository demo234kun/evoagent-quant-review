...
**Repository:** `聚宽2024/“7年40倍”策略扩容到50只`  
**Risk:** `high`  
...
`“7年40倍”策略扩容到50只.py:46` · **HIGH** · `QUANT-FF-GETPRICE-NO-ENDDATE`
...
**证据引用：** `local-rule:a86479a9f8390ce6`, `diff-ast:fef5942a95f2f3c9`
...
`“7年40倍”策略扩容到50只.py:164` · **HIGH** · `QUANT-FF-GETPRICE-NO-ENDDATE`
...
**证据引用：** `local-rule:348c0f4c10722096`, `diff-ast:3065e29323b7ef5d`
...
`“7年40倍”策略扩容到50只.py:192` · **HIGH** · `QUANT-FF-GETPRICE-NO-ENDDATE`
...
**证据引用：** `local-rule:97e400dcc5df64cf`, `diff-ast:9f24afb53b292c8a`
...
`“7年40倍”策略扩容到50只.py:21` · **MEDIUM** · `QUANT-EX-ZERO-COMM`
...
**证据引用：** `local-rule:09b341579c1e93e2`

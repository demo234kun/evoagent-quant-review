...
**Repository:** `聚宽2024/小试多因子策略，年化65%`  
**Risk:** `high`  
...
`小试多因子策略，年化65%.py:142` · **HIGH** · `QUANT-FF-GETPRICE-NO-ENDDATE`
...
**证据引用：** `local-rule:7773a7fa4f296fac`, `diff-ast:840af26d1bfd2438`
...
`小试多因子策略，年化65%.py:188` · **HIGH** · `QUANT-FF-GETPRICE-NO-ENDDATE`
...
**证据引用：** `local-rule:e5c520a1e143998e`, `diff-ast:f60c996c6579544e`
...
`小试多因子策略，年化65%.py:217` · **HIGH** · `QUANT-FF-GETPRICE-NO-ENDDATE`
...
**证据引用：** `local-rule:d66cf3999ca17233`, `diff-ast:0d9a7a3e50373c66`
...
`小试多因子策略，年化65%.py:32` · **MEDIUM** · `QUANT-EX-ZERO-COMM`
...
**证据引用：** `local-rule:f3fcbc1b9302d978`

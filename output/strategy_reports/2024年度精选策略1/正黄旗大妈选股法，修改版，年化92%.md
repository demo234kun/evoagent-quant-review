...
**Repository:** `聚宽2024/正黄旗大妈选股法，修改版，年化92%`  
**Risk:** `medium`  
...
`正黄旗大妈选股法，修改版，年化92%.py:28` · **MEDIUM** · `QUANT-EX-ZERO-COMM`
...
**证据引用：** `local-rule:a4530c26cf2f0c68`
...
`正黄旗大妈选股法，修改版，年化92%.py:63` · **LOW** · `QUANT-DQ-FILLNA0`
...
**证据引用：** `local-rule:3dc297cfdc17e2e1`

...
**Repository:** `聚宽2024/增强型投资组合优化（EPO）方法试用`  
**Risk:** `high`  
...
`增强型投资组合优化（EPO）方法试用.py:84` · **HIGH** · `QUANT-FF-GETPRICE-NO-ENDDATE`
...
**证据引用：** `local-rule:9385ad75d74c1f0d`, `diff-ast:0c43d47d5f341d4b`
...
`增强型投资组合优化（EPO）方法试用.py:14` · **MEDIUM** · `QUANT-EX-ZERO-COMM`
...
**证据引用：** `local-rule:5322db3cb4c77dbc`

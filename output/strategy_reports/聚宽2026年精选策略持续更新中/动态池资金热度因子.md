...
`动态池资金热度因子.py:37` · **MEDIUM** · `QUANT-EX-ZERO-COMM`
...
**证据引用：** `local-rule:1eec51a0ab11f84a`
...
`动态池资金热度因子.py:46` · **MEDIUM** · `QUANT-EX-ZERO-COMM`
...
**证据引用：** `local-rule:fdb510e23a5a2e2d`
...
`动态池资金热度因子.py:283` · **MEDIUM** · `QUANT-REL-NO-EXCEPTION`
...
**证据引用：** `local-rule:1f3c65b3c4b71474`

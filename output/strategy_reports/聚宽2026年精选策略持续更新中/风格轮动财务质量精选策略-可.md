...
**Repository:** `聚宽2026/风格轮动财务质量精选策略-可`  
**Risk:** `high`  
...
- Token 成本: `$0.00000000`；延迟: `191 ms`

## 审查发现

### 1. 🔴 get_price 未指定结束日期，默认拉取当前时刻数据

`风格轮动财务质量精选策略-可.py:154` · **HIGH** · `QUANT-FF-GETPRICE-NO-ENDDATE`
...
**证据引用：** `local-rule:0090203f888b0b88`, `diff-ast:ac38cbc28a8308db`
...
`风格轮动财务质量精选策略-可.py:165` · **HIGH** · `QUANT-FF-GETPRICE-NO-ENDDATE`
...
**证据引用：** `local-rule:efea89f7e2ecf18a`, `diff-ast:f032f9241b378bb5`
...
`风格轮动财务质量精选策略-可.py:27` · **MEDIUM** · `QUANT-EX-ZERO-ORDERCOST`
...
**证据引用：** `local-rule:ca5f352268986c24`
...
`风格轮动财务质量精选策略-可.py:28` · **MEDIUM** · `QUANT-EX-ZERO-COMM`
...
**证据引用：** `local-rule:dcc2d1c9e9195ca8`
...
`风格轮动财务质量精选策略-可.py:175` · **MEDIUM** · `QUANT-LK-INDEX-NOW`
...
**证据引用：** `local-rule:5c08ddc381df0929`
...
`风格轮动财务质量精选策略-可.py:199` · **MEDIUM** · `QUANT-LK-INDEX-NOW`
...
**证据引用：** `local-rule:b347a6dc56e01e99`
...
`风格轮动财务质量精选策略-可.py:249` · **MEDIUM** · `QUANT-LK-INDEX-NOW`
...
**证据引用：** `local-rule:df57d8c15f3a007b`
...
`风格轮动财务质量精选策略-可.py:254` · **MEDIUM** · `QUANT-LK-INDEX-NOW`
...
**证据引用：** `local-rule:415de8d8a13655b8`
...
`风格轮动财务质量精选策略-可.py:323` · **MEDIUM** · `QUANT-LK-INDEX-NOW`
...
**证据引用：** `local-rule:879252f9efc7613d`
...
`风格轮动财务质量精选策略-可.py:440` · **MEDIUM** · `QUANT-LK-INDEX-NOW`
...
**证据引用：** `local-rule:48ec5c17bfcc17cb`

...
`随机森林 - 多因子模型.py:377` · **HIGH** · `QUANT-FF-GETPRICE-NO-ENDDATE`
...
**证据引用：** `local-rule:12a890bb33847010`, `diff-ast:9afe51be6e9d9bf3`
...
`随机森林 - 多因子模型.py:377` · **HIGH** · `QUANT-DQ-ADJUST-POST`
...
**证据引用：** `local-rule:795673ef959eb6d4`, `diff-ast:899e76b2e88d424b`
...
`随机森林 - 多因子模型.py:396` · **MEDIUM** · `QUANT-LK-INDEX-NOW`
...
**证据引用：** `local-rule:aabcb062e8b5d691`

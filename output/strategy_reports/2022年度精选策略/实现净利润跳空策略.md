...
`实现净利润跳空策略.py:15` · **MEDIUM** · `QUANT-EX-ZERO-ORDERCOST`
...
**证据引用：** `local-rule:bbdf2f6933275476`
...
`实现净利润跳空策略.py:17` · **MEDIUM** · `QUANT-EX-ZERO-COMM`
...
**证据引用：** `local-rule:c62f9d2a58be17ed`
...
`实现净利润跳空策略.py:108` · **MEDIUM** · `QUANT-REL-NO-EXCEPTION`
...
**证据引用：** `local-rule:9e2e26dc4c5e5337`
...
`实现净利润跳空策略.py:119` · **MEDIUM** · `QUANT-REL-NO-EXCEPTION`
...
**证据引用：** `local-rule:37318debc6cfcd09`

...
**Repository:** `聚宽2021/市值，研发支出，roe，三因子，跑赢大盘`  
**Risk:** `high`  
...
`市值，研发支出，roe，三因子，跑赢大盘.py:108` · **HIGH** · `QUANT-FF-GETPRICE-NO-ENDDATE`
...
**证据引用：** `local-rule:0da4f3384f17411c`, `diff-ast:4f88d711c4dff7fc`
...
`市值，研发支出，roe，三因子，跑赢大盘.py:94` · **MEDIUM** · `QUANT-LK-INDEX-NOW`
...
**证据引用：** `local-rule:083d7c64fbe97f6d`

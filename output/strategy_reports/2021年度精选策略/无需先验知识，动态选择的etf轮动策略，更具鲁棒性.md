...
**Repository:** `聚宽2021/无需先验知识，动态选择的etf轮动策略，更具鲁棒性`  
**Risk:** `medium`  
...
`无需先验知识，动态选择的etf轮动策略，更具鲁棒性.py:135` · **MEDIUM** · `QUANT-EX-ZERO-COMM`
...
**证据引用：** `local-rule:ddc657793ac2f829`
...
`无需先验知识，动态选择的etf轮动策略，更具鲁棒性.py:294` · **MEDIUM** · `QUANT-REL-NO-EXCEPTION`
...
**证据引用：** `local-rule:02ce22ff22fdc4d6`

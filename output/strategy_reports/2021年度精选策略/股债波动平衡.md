...
`股债波动平衡.py:96` · **HIGH** · `QUANT-DQ-ADJUST-POST`
...
**证据引用：** `local-rule:cb70f33da24210d8`, `diff-ast:57f242f43493e6b7`
...
`股债波动平衡.py:22` · **MEDIUM** · `QUANT-EX-ZERO-COMM`
...
**证据引用：** `local-rule:469c47340848fc2c`

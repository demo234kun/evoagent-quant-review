...
`冲天炮最高板策略迭代.py:217` · **HIGH** · `QUANT-FF-GETPRICE-NO-ENDDATE`
...
**证据引用：** `local-rule:c985baaba3013877`, `diff-ast:acb97458e64b6eb7`
...
`冲天炮最高板策略迭代.py:218` · **HIGH** · `QUANT-FF-GETPRICE-NO-ENDDATE`
...
**证据引用：** `local-rule:774c92f71be3ed15`, `diff-ast:9f1f872daf6f4fdc`

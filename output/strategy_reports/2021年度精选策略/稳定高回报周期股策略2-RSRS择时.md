...
**Repository:** `聚宽2021/稳定高回报周期股策略2-RSRS择时`  
**Risk:** `medium`  
...
`稳定高回报周期股策略2-RSRS择时.py:302` · **MEDIUM** · `QUANT-LK-STATDATE`
...
**证据引用：** `local-rule:51efebbcdd60974a`
...
`稳定高回报周期股策略2-RSRS择时.py:307` · **LOW** · `QUANT-DQ-FILLNA0`
...
**证据引用：** `local-rule:39627b13dbc1f441`
